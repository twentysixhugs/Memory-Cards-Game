  ...
  return (
    <div className="c-rules">
      ...
      <p className="c-rules__text">
        ...
        Wars characters. The images get shuffled every time one of them is
        clicked. You cannot click on any image more than once, otherwise
        your score resets to zero. The main goal is to get the highest
        score as possible.
      </p>
